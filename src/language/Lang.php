...
use Ethanrobins\Chatbridge\Assets\Flag;
...
enum Lang
{
     ...
     * @return string The locale name in another language.
     */
    public function getLanguageNameInLanguage(Lang $lang): string
    {
        return match ($lang) {
            self::BULGARIAN => match ($this) {
            ...
            self::CHINESE_TAIWAN => match ($this) {
            ...
            self::PORTUGUESE_BRAZILIAN => match ($this) {
            ...
            self::ROMANIAN_ROMANIA => match ($this) {
    ...
    /**
     * @return Flag The respective locale's flag
     */
    public function getFlag(): Flag
    {
        return match ($this) {
            self::BULGARIAN            => Flag::BULGARIA,
            self::CHINESE_CHINA        => Flag::CHINA,
            self::CHINESE_TAIWAN       => Flag::TAIWAN,
            self::CROATIAN             => Flag::CROATIA,
            self::CZECH                => Flag::CZECH_REPUBLIC,
            self::DANISH               => Flag::DENMARK,
            self::DUTCH                => Flag::NETHERLANDS,
            self::ENGLISH_UK           => Flag::GREAT_BRITAIN,
            self::ENGLISH_US           => Flag::UNITED_STATES,
            self::FINNISH              => Flag::FINLAND,
            self::FRENCH               => Flag::FRANCE,
            self::GERMAN               => Flag::GERMANY,
            self::GREEK                => Flag::GREECE,
            self::HINDI                => Flag::INDIA,
            self::HUNGARIAN            => Flag::HUNGARY,
            self::INDONESIAN           => Flag::INDONESIA,
            self::ITALIAN              => Flag::ITALY,
            self::JAPANESE             => Flag::JAPAN,
            self::KOREAN               => Flag::SOUTH_KOREA,
            self::LITHUANIAN           => Flag::LITHUANIA,
            self::NORWEGIAN            => Flag::NORWAY,
            self::POLISH               => Flag::POLAND,
            self::PORTUGUESE_BRAZILIAN => Flag::BRAZIL,
            self::ROMANIAN_ROMANIA     => Flag::ROMANIA,
            self::RUSSIAN              => Flag::RUSSIA,
            self::SPANISH              => Flag::SPAIN,
            self::SPANISH_LATAM        => Flag::MEXICO,
            self::SWEDISH              => Flag::SWEDEN,
            self::THAI                 => Flag::THAILAND,
            self::TURKISH              => Flag::TURKEY,
            self::UKRAINIAN            => Flag::UKRAINE,
            self::VIETNAMESE           => Flag::VIETNAM,
